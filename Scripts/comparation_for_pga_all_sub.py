        ...
        for layer in EmptyLayer:
            ...
            if doublingData == 'yes':
                ...
                if classifier == 'LDA':
                    ...
                    name = nd.linear_svm(train_data, test_data, tr_label_name, te_label_name, random_label=False)
                    cate = nd.linear_svm(train_data, test_data, tr_label_category, te_label_category, random_label=False)
