...
class Run:
    ...
    def run_conditions(self, file_info, rangeOp, classifier, pgaOn):
            ...
            for layer2 in EmptyLayer:
                ...
                if doublingData == 'yes':
                    ...
                    if classifier == 'LDA':
                        ...
                        name = nd.linear_svm(train_data, test_data, tr_label_name, te_label_name)
                        cate = nd.linear_svm(train_data, test_data, tr_label_category, te_label_category)
    ...
    def main(self, classifier='rbf-SVM', pgaOn='no'):
        ...
        for d in range(len(directions)):
            ...
            for f in files:
                ...
                results = self.run_conditions(file_info=file_info, rangeOp=str(d), classifier=classifier, pgaOn=pgaOn)
